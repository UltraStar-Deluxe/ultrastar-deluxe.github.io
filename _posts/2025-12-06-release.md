...
## Breaking changes
* Refactor how the Options screens work internally, see [documentation page]({{ site.baseurl }}{% link docs/Theme-changes.md %}#2025120) for details if you provide or use a custom theme #1094 + #1108 + #1102
