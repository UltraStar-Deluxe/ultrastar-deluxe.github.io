...
## Breaking changes
* Remove Carousel, Slot Machine, Slide and Tile song selection modes. Custom theme providers, see [documentation page]({{ site.baseurl }}{% link docs/Theme-changes.md %}#202630) #1163
